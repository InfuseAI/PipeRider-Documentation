...
* [Installation](get-started/install-piperider/README.md)
  * [Supported Data Sources](get-started/install-piperider/supported-data-sources/README.md)
    * [BigQuery Connector](get-started/install-piperider/supported-data-sources/bigquery-connector.md)
    * [CSV Connector](get-started/install-piperider/supported-data-sources/csv-connector.md)
    * [DuckDB Connector](get-started/install-piperider/supported-data-sources/duckdb-connector.md)
    * [Postgres Connector](get-started/install-piperider/supported-data-sources/postgres-connector.md)
    * [Parquet Connector](get-started/install-piperider/supported-data-sources/parquet-connector.md)
    * [Redshift Connector](get-started/install-piperider/supported-data-sources/redshift-connector.md)
