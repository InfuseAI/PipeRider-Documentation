...
* [Command Reference](reference/commands/README.md)
  * [cloud](reference/commands/cloud/README.md)
    * [cloud compare-reports](reference/commands/cloud/cloud-compare-reports.md)
    * [cloud list-projects](reference/commands/cloud/cloud-list-projects.md)
    * [cloud login](reference/commands/cloud/cloud-login.md)
    * [cloud logout](reference/commands/cloud/cloud-logout.md)
    * [cloud select-project](reference/commands/cloud/cloud-select-project.md)
    * [cloud signup](reference/commands/cloud/cloud-signup.md)
    * [cloud upload-report](reference/commands/cloud/cloud-upload-report.md)
  * [compare](reference/commands/compare.md)
  * [compare-reports](reference/commands/compare-reports.md)
  * [config](reference/commands/config/README.md)
    * [config add-datasource](reference/commands/config/config-add-datasource.md)
    * [config delete-datasource](reference/commands/config/config-delete-datasource.md)
    * [config disable-auto-upload](reference/commands/config/config-disable-auto-upload.md)
    * [config disable-user-tracking](reference/commands/config/config-disable-user-tracking.md)
    * [config enable-auto-upload](reference/commands/config/config-enable-auto-upload.md)
    * [config enable-user-tracking](reference/commands/config/config-enable-user-tracking.md)
    * [config list-datasource](reference/commands/config/config-list-datasource.md)
  * [diagnose](reference/commands/diagnose.md)
  * [feedback](reference/commands/feedback.md)
  * [run](reference/commands/piperider-cli.md)
  * [init (deprecated)](reference/commands/piperider-cli-1.md)
...
* [Changelog (v0.34.0)](https://github.com/InfuseAI/piperider/releases/tag/v0.34.0)
